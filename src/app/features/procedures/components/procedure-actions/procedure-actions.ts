  ...
  template: `
    <div class="bg-card rounded-xl border border-border shadow-sm p-6">
      ...
      <div class="space-y-2">
        ...
        @if (canAdvance) {
          <button class="cursor-pointer w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-primary text-primary-foreground rounded-xl text-sm font-medium hover:bg-primary/90 transition-all shadow-sm hover:shadow-md hover:-translate-y-0.5"
        ...
        @if (canObserve) {
          <button class="cursor-pointer w-full flex items-center justify-center gap-2 px-4 py-2.5 border border-orange-300 text-orange-700 rounded-xl text-sm font-medium hover:bg-orange-50 transition-colors"
        ...
        @if (canFinishWithObservations) {
          <button class="cursor-pointer w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-orange-600 text-white rounded-xl text-sm font-medium hover:bg-orange-700 transition-all shadow-sm"
        ...
        @if (canPickup) {
          <button class="cursor-pointer w-full flex items-center justify-center gap-2 px-4 py-2.5 border border-purple-300 text-purple-700 rounded-xl text-sm font-medium hover:bg-purple-50 transition-colors"
        ...
        @if (canReentry) {
          <button class="cursor-pointer w-full flex items-center justify-center gap-2 px-4 py-2.5 border border-blue-300 text-blue-700 rounded-xl text-sm font-medium hover:bg-blue-50 transition-colors"
        ...
        @if (canAssign) {
          <button class="cursor-pointer w-full flex items-center justify-center gap-2 px-4 py-2.5 border border-border text-foreground rounded-xl text-sm font-medium hover:bg-muted transition-colors"
        ...
        @if (canAbandon) {
          <button class="cursor-pointer w-full flex items-center justify-center gap-2 px-4 py-2.5 border border-red-300 text-red-700 rounded-xl text-sm font-medium hover:bg-red-50 transition-colors mt-4"
        ...
        @if (canReverseAbandon) {
          <button class="cursor-pointer w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-amber-600 text-white rounded-xl text-sm font-medium hover:bg-amber-700 transition-colors"
